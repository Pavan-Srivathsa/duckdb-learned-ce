...
struct LearnedCeCollectTelemetrySetting {
    using RETURN_TYPE = bool;
    static constexpr const char *Name = "learned_ce_collect_telemetry";
    static constexpr const char *Description = "Collect experimental learned cardinality estimation telemetry during query optimization";
    static constexpr const char *InputType = "BOOLEAN";
    static constexpr const char *DefaultValue = "false";
    static constexpr SettingScopeTarget Scope = SettingScopeTarget::LOCAL_DEFAULT;
    static constexpr idx_t SettingIndex = NEXT_SETTING_INDEX();
...
struct LearnedCeConfidenceThresholdSetting {
    using RETURN_TYPE = double;
    static constexpr const char *Name = "learned_ce_confidence_threshold";
    static constexpr const char *Description = "Minimum model confidence required before hybrid/learned modes replace native cardinality estimates";
    static constexpr const char *InputType = "DOUBLE";
...
struct LearnedCeEnabledSetting {
    using RETURN_TYPE = bool;
    static constexpr const char *Name = "learned_ce_enabled";
    static constexpr const char *Description = "Enable experimental learned cardinality estimation during join-order optimization";
    static constexpr const char *InputType = "BOOLEAN";
    static constexpr const char *DefaultValue = "false";
    static constexpr SettingScopeTarget Scope = SettingScopeTarget::LOCAL_DEFAULT;
    static constexpr idx_t SettingIndex = NEXT_SETTING_INDEX();
...
struct LearnedCeModeSetting {
    using RETURN_TYPE = string;
    static constexpr const char *Name = "learned_ce_mode";
    static constexpr const char *Description = "Learned cardinality estimator mode: native, shadow, learned, hybrid, or adaptive";
    static constexpr const char *InputType = "VARCHAR";
    static constexpr const char *DefaultValue = "native";
    static constexpr SettingScopeTarget Scope = SettingScopeTarget::LOCAL_DEFAULT;
    static constexpr idx_t SettingIndex = NEXT_SETTING_INDEX();
    static void OnSet(SettingCallbackInfo &info, Value &input);
};

struct LearnedCeModelPathSetting {
    using RETURN_TYPE = string;
    static constexpr const char *Name = "learned_ce_model_path";
    static constexpr const char *Description = "Path to the ONNX model artifact used by the learned cardinality estimator";
    static constexpr const char *InputType = "VARCHAR";
    static constexpr const char *DefaultValue = "";
    static constexpr SettingScopeTarget Scope = SettingScopeTarget::LOCAL_DEFAULT;
    static constexpr idx_t SettingIndex = NEXT_SETTING_INDEX();
...
struct ShowBehaviorSetting {
    ...
    static constexpr const char *Description = "How SHOW resolves a bare identifier: 'auto' (describe a table if one exists, else a setting; deprecated), 'table' (always a table), or 'setting' (always a setting)";
    static constexpr const char *InputType = "VARCHAR";
    static constexpr const char *DefaultValue = "AUTO";
    static constexpr SettingScopeTarget Scope = SettingScopeTarget::GLOBAL_DEFAULT;
    static constexpr idx_t SettingIndex = NEXT_SETTING_INDEX();
